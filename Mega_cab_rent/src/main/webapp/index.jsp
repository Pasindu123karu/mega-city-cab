...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Mega City Cab</a>
			<button
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Mega City Cab is your go-to transportation service offering fast, safe, and reliable rides within the city. Our platform provides an easy way to book a ride, track your driver, and pay securely all in one place.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">We ensure that all our drivers are well-trained and background-checked for your safety and comfort. With 24/7 customer support, we are here to assist you with any needs at any time.</p>
				</div>
			</div>
		</div>
	</section>
